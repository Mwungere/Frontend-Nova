    ...
    <div className=' w-full mt-20 flex flex-col' id="services">
      <div className=' flex  h-[13em] '>
        <div className=' ml-10 w-3/4  '>
          ...
          <p className=' font-body mt-10 text-[#353535]'>Explore our exceptional landscaping services, where meticulous attention to detail <br /> and creative design  converge to transform outdoor spaces.</p>
        </div>
        <Image
          src='/blur.svg'
          width={438}
