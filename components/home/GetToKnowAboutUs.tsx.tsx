    ...
    <div className=' w-full flex flex-col'>
      <div className=' w-full flex mt-18 flex-col md:flex-row-reverse justify-around mx-auto py-10'>
        <div className='flex-1 lg:mr-40 lg:mt-[45px]'>
          <h1 className={`${colorMode? 'text-[#9CE791]':'text-secondary'} font-body font-bold text-4xl mt-10 mb-4 lg:text-6xl lg:mb-7`}>Get To Know More <br /> About Us!</h1>
          <p className={`${colorMode? 'text-[#CBC6BF]':'text-[#2f2e2e]'} font-body lg:text-xl`}>
          ...
          <button className=' bg-secondary text-white p-3 px-20 rounded-3xl flex gap-10 mx-auto my-3  lg:mt-4 font-body'>
            <span className={`${colorMode? 'text-[#CBC6BF]' : ' text-white'}`}>Get started</span>
            <Image
              src='/arrow.svg'
              width={25.15}
              height={14.8}
      ...
      <div className='flex flex-wrap md:flex-row w-full justify-around mb-20 items-center'>
        <div className='flex-col  md:border-r-2 border-[#525252] pr-8'>
          <h1 className={`font-body ${ colorMode? 'text-[#C8C3bC]':'text-[#232A42]'} text-4xl lg:text-5xl font-medium mb-4 ml-5`}>15+</h1>
          <p className={`font-body ${ colorMode? 'text-[#C8C3bC]':'text-[#232A42]'}`}>Years Experience</p>
        </div>
        <div className='flex-col md:border-r-2 border-[#525252] pr-12'>
          <h1 className={`font-body ${ colorMode? 'text-[#C8C3bC]':'text-[#232A42]'} text-4xl lg:text-5xl font-medium mb-4`}>2k+</h1>
          <p className={`font-body ${ colorMode? 'text-[#C8C3bC]':'text-[#232A42]'}`}>Products</p>
        </div>
        <div className='flex-col md:border-r-2 border-[#525252] pr-16'>
          <h1 className={`font-body ${ colorMode? 'text-[#C8C3bC]':'text-[#232A42]'} text-4xl lg:text-5xl font-medium mb-4 ml-5`}>5k+</h1>
          <p className={`font-body ${ colorMode? 'text-[#C8C3bC]':'text-[#232A42]'}`}>Satisfied Clients</p>
        </div>
        <div className='flex-col'>
          <h1 className={`font-body ${ colorMode? 'text-[#C8C3bC]':'text-[#232A42]'} text-4xl lg:text-5xl font-medium mb-4 ml-9`}>5+</h1>
          <p className={`font-body ${ colorMode? 'text-[#C8C3bC]':'text-[#232A42]'}`}>Local Team Members</p>
        </div>
      </div>
