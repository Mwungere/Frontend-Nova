        ...
        <div className=' font-body flex flex-col lg:flex-row items-center mx-auto px-20 py-10'>
            <div className=' flex flex-col flex-1 lg:mt-36 mt-44'>
                ...
                <div className=' flex mt-20 mx-auto lg:ml-5 gap-10'>
                    ...
                    <button className={` ${colorMode? ' bg-transparent border-[#5e5e5f]':' bg-white'}  border-2 rounded-md shadow-xl p-3 lg:px-10 flex gap-3 `}>
                        ...
                        <div className='lg:mt-2'>
                            <p className={` ${colorMode? ' text-[#CBC6BF]':''} font-body text-sm`}>Available on the</p>
                            <h1 className={`${colorMode? ' text-[#CBC6BF]':''} font-body font-bold text-xl`}>Play Store</h1>
                        </div>
            ...
            <div className='flex flex-col h-auto'>
                <div className=' w-[460px] h-[460px] lg:w-[550px] lg:h-[550px] lg:p-5 p-10 rounded-full border-[1px] border-secondary lg:mt-16 mt-10 lg:self-center items-center'>
                    <div className={`w-[400px] h-[400px] rounded-full  ${colorMode? 'bg-[#3B4933]':'bg-circular'} lg:w-[478px] lg:h-[478px] lg:mx-auto lg:my-auto lg:mt-2 items-center pt-7 lg:pt-12`}>
                        <Image
                            src="/garden.png"
                            width={340}
                            height={340}
